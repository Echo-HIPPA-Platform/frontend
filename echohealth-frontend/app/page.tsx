...
import { Heart, Users, Calendar, MessageCircle, Star, CheckCircle, ArrowRight, Phone, Mail, MapPin } from 'lucide-react';
...
export default function Home() {
  ...
  const testimonials = [
    {
      text: "Echo Psychology helped me find my voice again. The therapists here truly listen and care.",
      name: "---",
      rating: 5
    },
    {
      text: "A safe space where I could be vulnerable and work through my challenges with compassion.",
      name: "---",
      rating: 5
    },
    {
      text: "The group therapy sessions changed my perspective. I felt supported every step of the way.",
      name: "----",
      rating: 5
    }
  ];
  ...
  const services = [
    {
      ...
      description: "Work one-on-one with our licensed therapists to explore personal challenges, develop coping strategies, and achieve meaningful growth in a confidential space.",
      color: "bg-gradient-to-br from-emerald-50 to-teal-50"
    },
    {
      icon: Users,
      title: "Group Therapy",
      description: "Join a supportive community and share experiences in a safe group setting. Benefit from collective wisdom and mutual encouragement.",
      color: "bg-gradient-to-br from-blue-50 to-cyan-50"
    },
    {
      icon: Heart,
      title: "Stress & Anxiety Management",
      description: "Learn practical strategies and techniques to manage stress and reduce anxiety, empowering you to regain balance and peace of mind.",
      color: "bg-gradient-to-br from-rose-50 to-pink-50"
    },
    {
      icon: Users,
      title: "Couples & Family Therapy",
      description: "Enhance communication, resolve conflicts, and build stronger relationships with the support of our experienced therapists.",
    ...
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-white to-blue-50">
      ...
      <nav className="relative z-10 flex justify-between items-center px-8 sm:px-20 py-6 bg-white/80 backdrop-blur-sm border-b border-emerald-100">
        ...
        <div className="flex items-center gap-6">
          <a href="#services" className="text-slate-600 hover:text-emerald-600 transition-colors">Services</a>
          ...
          <a href="#contact" className="text-slate-600 hover:text-emerald-600 transition-colors">Resources</a>
          <a href="/auth/signup" className="text-slate-600 hover:text-emerald-600 transition-colors">Sign In</a>
        </div>
      </nav>

      <main className="relative z-10">
        {/* Hero Section */}
        <section className={`px-8 sm:px-20 py-20 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            ...
            <div className="flex flex-col lg:flex-row items-center gap-12">
              ...
              <div className="flex-1 text-center lg:text-left">
                ...
                <p className="text-xl text-slate-600 mb-8 leading-relaxed max-w-2xl">
                  At Echo Psychology Services, we create a warm, secure environment where you can explore your thoughts and emotions. Our compassionate team of licensed professionals guides you with personalized care.
                </p>
              ...
              <div className="flex-1 flex justify-center">
                <div className="relative">
                  <div className="w-96 h-96 bg-gradient-to-br from-emerald-100 to-teal-100 rounded-3xl shadow-2xl overflow-hidden">
                    <div className="w-full h-full bg-gradient-to-br from-emerald-200/50 to-teal-200/50 flex items-center justify-center">
                      <div className="text-center">
                        <Heart className="w-24 h-24 text-emerald-500 mx-auto mb-4" />
                        <p className="text-emerald-700 font-medium">A serene and welcoming therapy space</p>
                      </div>
                    </div>
                  </div>
                  {/* Floating elements */}
                  <div className="absolute -top-4 -right-4 w-20 h-20 bg-gradient-to-br from-rose-400 to-pink-400 rounded-full blur-sm opacity-60 animate-pulse"></div>
                  <div className="absolute -bottom-6 -left-6 w-16 h-16 bg-gradient-to-br from-blue-400 to-cyan-400 rounded-full blur-sm opacity-60 animate-pulse delay-1000"></div>
                </div>
              </div>
            </div>
          </div>
        ...
        {/* Services Section */}
        <section id="services" className="px-8 sm:px-20 py-20 bg-white/50">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              {services.map((service, index) => {
                ...
                return (
                  <div
                    key={index}
                    className={`${service.color} p-8 rounded-3xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border border-white/50`}
                  >
        ...
        <section id="testimonials" className="px-8 sm:px-20 py-20">
        ...
        {/* CTA Section */}
        <section className="px-8 sm:px-20 py-20 bg-gradient-to-r from-emerald-500 to-teal-600">
          <div className="max-w-4xl mx-auto text-center text-white">
            <h3 className="text-4xl font-bold mb-6">
              Ready to Begin Your Journey?
            </h3>
            <p className="text-xl mb-8 opacity-90">
              Your well-being is our priority. Take the first step towards improved mental health today.
        ...
        {/* Contact Section */}
        <section id="contact" className="px-8 sm:px-20 py-20 bg-slate-50">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <div className="bg-white p-8 rounded-3xl shadow-lg text-center">
                ...
                <p className="text-rose-600 font-semibold">Vitural accessible</p>
              </div>
            </div>
          </div>
        </section>
      ...
      {/* Footer */}
      <footer className="bg-slate-800 text-white px-8 sm:px-20 py-12">
